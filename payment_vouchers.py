...
def create_payment_voucher(date, account_name, ledger_name, amount, narration):
...
def validate_csv(df):
    ...
    if df.empty:
        print("\n❌ payment_entries.csv contains no transactions.\n")
        return False
...
def main():
    ...
    try:
        ...
        print("\n❌ payment_entries.csv was not found.")
    ...
    print(f"\n📄 Processing {len(df)} payment voucher(s)...")
